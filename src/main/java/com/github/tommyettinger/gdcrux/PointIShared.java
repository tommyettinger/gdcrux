...
import com.github.tommyettinger.crux.PointNInt;
 ...
 */
public interface PointIShared<P extends PointIShared<P, R>, R extends PointN<?>> extends PointNInt<P, R>, Iterable<Integer> {
    @Override
