...
/**
 * The same as {@link Vector3}, just implementing {@link Point3}, {@link Json.Serializable},
 ...
 */
public class PointF3 extends Vector3 implements Point3<PointF3>, PointFShared<PointF3, Point3<?>>, Json.Serializable, Externalizable {
    ...
    @Override
    public PointF3 plus(float value) {
        super.add(value);
        return this;
    }
    ...
    @Override
    public PointF3 minus(float value) {
        super.sub(value);
        return this;
    }
    ...
    @Override
    public PointF3 lerp (final Point3<?> target, float alpha) {
        x += alpha * (target.x() - x);
        y += alpha * (target.y() - y);
        z += alpha * (target.z() - z);
        return this;
    ...
    public PointF3 slerpGeometric(PointF3 target, float alpha) {
     ...
     */
    @SuppressWarnings("DefaultNotLastCaseInSwitch")
    public PointF3 setAt(int index, float value){
        switch (index){
            default: x = value;
            case 1 : y = value;
            case 2 : z = value;
